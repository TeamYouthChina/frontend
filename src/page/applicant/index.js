...
class ApplicantReact extends React.Component {
  constructor(props) {
    super(props);
    // state
    this.state = {
    ...
    // i18n
    this.text = ApplicantReact.i18n[languageHelper()];
  }
  ...
  async componentDidMount() {
    ...
    const result = await getAsync(`/applicant/${this.props.match.params.id}`);
          ...
          <div>
            ...
            <Switch>
              ...
              */}
              <Route
                path={`${this.props.match.url}/profile`}
                component={routeProps => <Profile requestID={this.props.match.params.id} {...routeProps} />}
              />
...
export const Applicant = ApplicantReact;
