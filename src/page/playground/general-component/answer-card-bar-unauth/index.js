...
export class AnswerCardWithoutAuth extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editorState: null,
    ...
    // 多语言
    this.text = AnswerCardWithoutAuth.i18n[languageHelper()];
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(AnswerCardWithoutAuth);
